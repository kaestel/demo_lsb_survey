...
//			console.log(new Date(div.div_questionaire.ends_at).getDate());
		}
		...
		div.div_questionaire.loaded = function(queue) {
			...
			// render remaining page
//			u.t.setTimer(this.div, "ready", 600);
...
//				u.bug("intro clicked");
				...
				// go straight to signup (for dev)
//				u.t.setTimer(this.div, "showSignup", (i*75 + 400));
		...
		div.questionaireIntro = function() {
			...
			if(this.div_questionaire.ends_at && this.div_questionaire.ends_at < new Date().getTime()) {
				...
				paragraph.innerHTML = "Unders&oslash;gelsen er slut. Vinderne er fundet og har f&aring;et direkte besked. <br />Tak til alle deltagere."
				u.ass(button, {
					"display": "none"
				});
...
//				}
			...
			// Save answer
//			u.request(this, "http://lsb-kampagne.local/janitor/participant/saveParticipantAnswer", {"params":"question="+question+"&answer="+answer+"&csrf="+(question*answer*fear)+(this.user_id ? "&name="+this.user_id : ""), "method":"post"});
//			u.request(this, host+"/janitor/participant/saveParticipantAnswer", {"params":"question="+question+"&answer="+answer+"&csrf="+(question*answer*fear)+(this.user_id ? "&name="+this.user_id : ""), "method":"post"});
		...
		div.showAnswer = function(question) {
			...
			if(!this.answer) {
				...
				var row_1 = u.ae(this.answer, "div", {"class":"row r1"});
				this.answer.h4 = u.ae(row_1, "h4", {"class":"pretext", "html":"Du svarede"});
				this.answer.h2 = u.ae(row_1, "h2", {"class":"question"});

				var row_2 = u.ae(this.answer, "div", {"class":"row r2"});

				var column_1 = u.ae(row_2, "div", {"class":"column c1"});
				this.answer.pie = u.ae(column_1, "div", {"class":"pie"});

				var column_2 = u.ae(row_2, "div", {"class":"column c2"});
				var table = u.ae(column_2, "div", {"class":"table"});
				var cell = u.ae(table, "div", {"class":"cell"});
				this.answer.ul_options = u.ae(cell, "ul", {"class":"options"});


				var row_3 = u.ae(this.answer, "div", {"class":"row r3"});
				var ul_actions = u.ae(row_3, "ul", {"class":"actions"});
				this.answer.action = u.ae(ul_actions, "li", {"class":"next"});
				this.answer.action.div = this;
				u.ce(this.answer.action);


				// var column_1 = u.ae(this.answer, "div", {"class":"column c1"});
				// this.answer.pie = u.ae(column_1, "div", {"class":"pie"});
				// this.answer.ul_options = u.ae(column_1, "ul", {"class":"options"});
				//
				//
				// var column_2 = u.ae(this.answer, "div", {"class":"column c2"});
				// this.answer.h4 = u.ae(column_2, "h4", {"class":"pretext", "html":"Du svarede"});
				// this.answer.h2 = u.ae(column_2, "h2", {"class":"question"});
				//
			...
			this.answer.action.clicked = function() {
		...
		div.showSignup = function() {
			...
			this.form_signup.fields["fullname"].autocomplete = "off";
			this.form_signup.fields["email"].field._indicator.innerHTML = "U";
			this.form_signup.fields["email"].autocomplete = "off";
			this.form_signup.fields["phone"].field._indicator.innerHTML = "U";
			this.form_signup.fields["phone"].autocomplete = "off";
			this.form_signup.fields["postal"].field._indicator.innerHTML = "U";
			this.form_signup.fields["postal"].autocomplete = "off";
			...
			// 	u.rc(this, "hover");
			// }
			this.form_signup.updated = function() {

				if(this.div.form_callme) {

					this.div.form_callme.fields["fullname"].val(this.fields["fullname"].val());
					this.div.form_callme.fields["postal"].val(this.fields["postal"].val());
					this.div.form_callme.fields["phone"].val(this.fields["phone"].val());
					this.div.form_callme.fields["email"].val(this.fields["email"].val());
	...
	//				u.request(this, "http://lsb-kampagne.local/janitor/participant/saveParticipantData", {"method":"post", "params":u.f.getParams(this)+"&name="+this.div.user_id});
...
//			u.bug("drawPie");
			...
			this.pie_canvas = u.ae(this.answer.pie, "canvas", {"width":this.answer.pie.offsetWidth, "height":this.answer.pie.offsetHeight});
...
//					console.log("end_degree:" + end_degree + ", current_degree:" + current_degree);
		...
		div.initCallme = function() {
			...
			this.form_callme.updated = function() {
				if(this.div.form_signup && this.div.form_signup.fields) {

					this.div.form_signup.fields["fullname"].val(this.fields["fullname"].val());
					this.div.form_signup.fields["postal"].val(this.fields["postal"].val());
					this.div.form_signup.fields["phone"].val(this.fields["phone"].val());
					this.div.form_signup.fields["email"].val(this.fields["email"].val());
...
//					u.request(this, host+"/janitor/participant/saveCallmeData", {"method":"post", "params":u.f.getParams(this)});
		...
		div.ready = function() {
			...
			u.t.setTimer(this, "quizIntro", 1500);
...
//				u.ae(this.callme_top_button.parentNode, "p", {"html":"Og f&aring; et gavekort p&aring; 250 kr. til gavekortet.dk."});
			...
			if(this.callme_signup_button) {
				...
				this.callme_signup_button.clicked = function() {
					var column1 = u.pn(this, {include:"div"});
					var column2 = u.ns(column1, {include:"div"});
					u.a.transition(column1, "all 0.4s ease-in-out");
					u.ass(column1, {
						"opacity":0,
						"padding": 0,
						"width": ((this.div.offsetWidth - column2.offsetWidth) / 2) + "px"
					});
					//console.log("right");
					this.div.form_signup.fields["callme"].val("true");
...
//					u.scrollTo(window, {"node":this.div.callme, "offset_y":30});
			...
			if(this.become_client_button_1) {
				...
				this.become_client_button_1.clicked = function() {
					var url = this.getAttribute("data-url-desktop") || this.url;
					window.open(url);
				}
			}
...
//			this.meeting_splash = u.qs("div.meeting_splash", this);

//			u.ie(this.callme, this.meeting_splash);

			// u.ass(this.meeting_splash, {
			// 	"display":"block"
			// });

			// was form submitted
//			console.log("view:" + u.getVar("view"))
			// if(u.getVar("view")) {
			// 	u.t.setTimer(this, "showForm", 500);
			// }


		}

		// div.showForm = function() {
		// 	u.scrollTo(window, {"node":this.callme});
		// }
